        ...
        <div class="container mx-auto flex flex-wrap justify-between items-start md:pt-2">
            <div class="rounded-lg w-full lg:w-1/2 mb-3 lg:mb-0">
                ...
                <p class="mb-4">Email: <a href="mailto:brunohoinackib@gmail.com"
                        class="hover:text-teal-300">brunohoinackib@gmail.com</a></p>
                <p class="mb-4">Telefone: <a href="tel:+5551980456224" class="hover:text-teal-300">(51)
                        9
                        8045-6224</a></p>
                <p class="mb-4">Endereço: Rua 15 de outubro, 100 - Vale dos pinheiros, Gramado - RS</p>
            </div>
            <div class="w-full md:w-1/2">
                <div class=" border border-teal-500 p-5 mb-4 mb:mb-0 md:p-6 rounded-lg">
                    ...
                    <form class="space-y-4" action="https://formsubmit.co/brunohoinackib@gmail.com" method="POST">
                        ...
                        <button type="submit" class="w-full p-2 rounded-md bg-teal-500 hover:bg-teal-600 text-white hover:text-gray-300 transition ease-in-out delay-150 hover:scale-105 duration-700 
                            ">Encaminhar</button>
                    </form>
                </div>
            </div>
